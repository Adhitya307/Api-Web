    ...
    <main class="flex-shrink-0">
        ...
        <div class="container">
          <div class="hero-content">
            <div class="hero-text" data-aos="fade-right" data-aos-duration="1000">
              <h1 class="typing-text">Selamat Datang di Sistem Monitoring PLTA Saguling</h1>
              <p class="lead fade-in-text">
                Efisiensi, keamanan, dan transparansi operasional pembangkit listrik tenaga air berbasis teknologi digital.
              </p>
              <a href="/menu" class="btn btn-primary btn-cta pulse-animation">
            ...
            <div class="hero-image" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="300">
              <img src="img/slide1.jpg" alt="Monitoring Bendungan Saguling" class="img-fluid floating-img">
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row g-4">
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
              <div class="card vision-card hover-lift">
                <div class="card-body">
                  <div class="card-icon">
                    <i class="bi bi-eye"></i>
                  </div>
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
              <div class="card mission-card hover-lift">
                <div class="card-body">
                  <div class="card-icon">
                  ...
                  <ul class="mission-list">
                    <li data-aos="fade-up" data-aos-delay="100"><i class="bi bi-check-circle"></i> Memberikan pelayanan operasi dan pemeliharaan yang andal dan efisien</li>
                    <li data-aos="fade-up" data-aos-delay="200"><i class="bi bi-check-circle"></i> Mendorong digitalisasi dan transformasi teknologi</li>
                    <li data-aos="fade-up" data-aos-delay="300"><i class="bi bi-check-circle"></i> Mengutamakan keselamatan dan kelestarian lingkungan</li>
                    <li data-aos="fade-up" data-aos-delay="400"><i class="bi bi-check-circle"></i> Mengembangkan SDM yang profesional dan berintegritas</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-4" data-aos="fade-left" data-aos-duration="800" data-aos-delay="300">
              <div class="about-image">
                <img src="img/Foto.jpg" alt="PLTA Saguling" class="img-fluid rounded floating-img">
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="kontak" class="section contact-section">
        <div class="container">
          ...
          <div class="row g-4">
            <div class="col-md-6">
              <div class="contact-info hover-lift" data-aos="fade-right" data-aos-duration="800">
